...
chartjsLineChartOne(
  ...
  (bgColor = "#20C99710"),
  (bColor = "#20C997"),
  (data = [135, 105, 200, 250, 225, 300, 325])
);
chartjsLineChartOne(
  "#lineChartTwo",
  (label = "Label"),
  (bgColor = "rgb(32, 201, 151,.1)"),
  (bColor = "#20C997"),
  (data = [200, 175, 250, 250, 100, 200, 250])
);
chartjsLineChartOne(
  "#lineChartThree",
  (label = "Label"),
...
chartjsLineChartOne(
  ...
  (bgColor = "rgb(32, 201, 151,.1)"),
  (bColor = "#20C997"),
  (data = [200, 150, 200, 250, 100, 200, 400])
);
    ...
    var charts = new Chart(ctxs, {
      ...
      data: {
        ...
        datasets: [{
          ...
          pointHoverBackgroundColor: pcolor,
          pointHoverRadius: 6,
...
function toOverviewMonth() {
  ...
  chartjsLineChartTwo(
    "lineChartSharpTwoM",
    55,
    (data = [0, 10, 8, 15, 7, 10, 15, 20, 18, 35, 17, 18]),
    '#c92020',
  );
  ...
  chartjsLineChartTwo(
    "lineChartSharpFourM",
    55,
    (data = [0, 15, 10, 18, 20, 15, 10, 7, 15, 8, 10, 18]),
    '#c92020',
  );
  chartjsLineChartTwo(
    "lineChartSharpFiveM",
...
chartjsBarChartOne(
  "ys_barChartOne",
  dataG = (data = [40, 50, 38, 42, 48]),
  dataL = (data = [21,28,18,22,24]),
...
function ySubscriberMonth() {
  chartjsBarChartOne(
    "ys_barChartTwo",
    dataG = (data = [40, 50, 38, 42, 48, 38]),
    dataL = (data = [21,28,18,22,24,21]),
    labels = ["1-7", "8-14", "15-21", "21-28", "28+"]
  );
}
...
function ySubscriberYear() {
  chartjsBarChartOne(
    "ys_barChartThree",
    dataG = (data = [40, 50, 38, 42, 48, 38, 41,48,54,34,42,41]),
    dataL = (data = [21,28,18,22,24,21,19,21,24,20,21,21]),
    labels = ["Jan",
      "Feb",
      "Mar",
      "Apr",
  ...
  if (ctx) {
    ...
    var chart = new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
          data: [5870, 4483, 2420],
          backgroundColor: ["#bababa", "#5c5c5c", "#cc0000"],
        }, ],
      },
      options: {
        maintainAspectRatio: true,
  ...
  if (ctx) {
    ...
    var chart = new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
          data: data,
          backgroundColor: ["#c92020", "#636363", "#bfbfbf"],
          total: "9,283",
        }, ],
      },
      options: {
